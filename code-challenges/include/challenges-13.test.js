...
accumulator.concat([currentValue.charAt(0)]), []);
...
// Solution code here...
arr.reduce( (accumulator, currentValue) => 
currentValue.includes(':)') ? accumulator.concat([currentValue]) : accumulator, []);
...
index % 2 !== 0 ? accumulator + currentValue : accumulator, '');
...
// Solution code here...
arr.reduce( (accumulator, currentValue) => 
currentValue.includes(target) ? accumulator.concat([currentValue]) : accumulator, []);
