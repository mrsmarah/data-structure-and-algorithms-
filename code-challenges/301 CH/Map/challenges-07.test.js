...
const extractAbilities = (arr) => {
  ...
  let arr2 = arr.map((val) => {
    ...
    let  objVal2  = Object.values(objVal[2]);
    return objVal2[1];
  });
  return arr2;
};
...
const extractStats = (arr) => {
  ...
  let arr2 = arr.map((val) => {
    ...
    let objVal2 = Object.values(objVal[0]);
    return {name:objVal2[1] , total:sum};
  });
  return arr2;
};
