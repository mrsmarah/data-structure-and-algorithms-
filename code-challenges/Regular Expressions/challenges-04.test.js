...
const citiesAtoJ = (arr) => {
  // Solution code here...
{ let newArr = []; arr.forEach(element => { let temp = element.match(/^[A-J].*/); if(temp){ newArr.push(temp[0]); } }); return newArr;};
};
...
const noPunctuation = str => {
  // Solution code here...
  str.match(/[A-Za-z0-9]+\s/g) !== null ? str.match(/[A-Za-z0-9]+\s/g) : [];
};
